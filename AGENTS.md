...
@ocash/sdk is a TypeScript ZKP SDK for privacy-preserving token operations — deposit, transfer, withdraw — via UTXO model and zk-SNARK proofs (Groth16, Go WASM). Headless, multi-environment (browser, Node.js, Electron/Tauri), factory pattern.
